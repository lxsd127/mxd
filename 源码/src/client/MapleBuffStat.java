...
public enum MapleBuffStat implements Serializable, Buffstat {
    ...
    DARKSIGHT(0x400, 1),//隐身术
    BOOSTER(0x800, 1),//攻击加速
    POWERGUARD(0x1000, 1),//伤害反击
    MAXHP(0x2000, 1),//最大HP
    MAXMP(0x4000, 1),//最大MP
    INVINCIBLE(0x8000, 1),//神之保护
    SOULARROW(0x10000, 1),//无形弓弩
    COMBO(0x200000, 1),//斗气集中
    SUMMON(0x200000, 1), //召唤兽hack buffstat for summons ^.- (does/should not increase damage... hopefully <3)
    WK_CHARGE(0x400000, 1),//属性攻击
    DRAGONBLOOD(0x800000, 1),//龙之力
    HOLY_SYMBOL(0x1000000, 1),//神圣祈祷
    MESOUP(0x2000000, 1),//聚财术
    SHADOWPARTNER(0x4000000, 1),//影分身
    PICKPOCKET(0x8000000, 1),//敛财术
    PUPPET(0x8000000, 1), //替身术 HACK - shares buffmask with pickpocket - odin special ^.-
    ...
    HP_BOOST_PERCENT(0x200, 7, true),//增强_最大HP
    MP_BOOST_PERCENT(0x400, 7, true),//增强_最大MP
    //speshul
    ENERGY_CHARGE(0x8, 3),//冒险岛勇士
    DASH_SPEED(0x10, 3),//稳如泰山
    DASH_JUMP(0x20, 3),//火眼晶晶
    MONSTER_RIDING(0x40, 3),//魔法反击
    SPEED_INFUSION(0x80, 3),//龙咆哮
    HOMING_BEACON(0x100, 3, true),//暗器伤人
    DEFAULT_BUFFSTAT(0x200, 3),;//终极无限
