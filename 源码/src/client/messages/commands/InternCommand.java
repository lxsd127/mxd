...
public class InternCommand {
    ...
    public static class 更换发型 extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            player.dropMessage(5, "您当前的发型ID被更改为: " + id);
            return 1;
        }
    ...
    public static class TempB extends 临时封号 {
    }
    ...
    public static class B extends 封号 {
    }
    ...
    public static class 踢下线 extends DC {
    ...
    public static class 玩家信息 extends CommandExecute {
    ...
    public static class 秒怪 extends KillAll {
    }
