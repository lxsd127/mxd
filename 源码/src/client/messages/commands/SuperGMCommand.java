...
import client.messages.commands.InternCommand.封号;
...
public class SuperGMCommand {
    ...
    public static class HellBan extends 封号 {
    ...
    public static class 丢随机属性道具 extends CommandExecute {
...
//                  c.getPlayer().getMap().broadcastMessage(MobPacket.moveMonster(false, -1, 0, 0, 0, 0, monster.getObjectId(), monster.getTruePosition(), c.getPlayer().getLastRes()));
    ...
    public static class 设置NPC extends CommandExecute {
    ...
    public static class 刷怪 extends CommandExecute {
    ...
    public static class 给点数 extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            if (ch <= 0) {
                c.getPlayer().dropMessage(5, "該玩家不在線上");
                return 1;
            }
            ...
            player.dropMessage(5, "已經收到点卷點數" + amount + "點");
    ...
    public static class 给抵用卷 extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            player.dropMessage(5, "已經收到抵用卷點數" + amount + "點");

            return 1;
        }
    }

    public static class 给自己点卷 extends CommandExecute {
    ...
    public static class 给自己抵用卷 extends CommandExecute {
    ...
    public static class 倍率 extends CommandExecute {
...
//                    }
                ...
                if (bOk) {
                    ...
                    mc.dropMessage(6, "使用方法: !倍率 <exp经验|drop爆率|meso金币|bossboss爆率|pet> <类> <秒> <分> <时>");
                }
            } else {
                mc.dropMessage(6, "使用方法: !倍率 <exp经验|drop爆率|meso金币|bossboss爆率|pet> <类> <秒> <分> <时>");
            }
