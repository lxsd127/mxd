...
public class MapleAESOFB {
    ...
    private final static SecretKeySpec skey = new SecretKeySpec(new byte[]{(byte) 0xBF, 0x00, 0x00, 0x00, (byte) 0x91, 0x00, 0x00, 0x00, (byte) 0x92, 0x00, 0x00, 0x00, (byte) 0xE1, 0x00, 0x00, 0x00, (byte) 0x7D, 0x00, 0x00, 0x00, (byte) 0x65, 0x00, 0x00, 0x00, (byte) 0xD0, 0x00, 0x00, 0x00, (byte) 0xBE, 0x00, 0x00, 0x00}, "AES");
    ...
    public byte[] crypt(byte[] data) {
        ...
        int llength;
        llength = ServerConfig.USE_FIXED_IV ? 0x5CF :0x5B0;
        int start = 0;
        ...
        try {
            while (remaining > 0) {
                ...
                start += llength;
                remaining -= llength;
                llength = ServerConfig.USE_FIXED_IV ? 0x5D3 :0x5B4;
            }
            updateIv();
